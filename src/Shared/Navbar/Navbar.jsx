...
import img1 from '../../assets/letter-j (2).png'


const Navbar = () => {
    const [isToggleOpen, setIsToggleOpen] = useState(false)
    const navlinks=<>
    <li className="flex items-stretch  "><NavLink
                  role="menuitem"
                  aria-haspopup="false"
                  className="flex items-center gap-2 py-4 transition-colors duration-300 hover:text-[#e78b3a] focus:text-[#e78b3a] focus:outline-none focus-visible:outline-none lg:px-8"
    ...
    return (
      ...
      <header className="border-b-1 relative z-20 w-full  bg-black shadow-lg shadow-slate-700/5 after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            {/*      <!-- Mobile trigger --> */}
            <button
              className={`relative order-10 block h-10 w-10 self-center lg:hidden bg-[#e78b3a]
                ${
                  isToggleOpen
